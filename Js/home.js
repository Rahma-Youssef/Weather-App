      ...
      <div class="p-4">
        ...
        <div class="details d-flex gap-4 mt-3">
          <span class="d-flex align-items-center gap-2">
            <img src="./images/imgi_3_icon-umberella.png" class="w-50" alt=""> ${current.humidity}%
          </span>
          <span class="d-flex align-items-center gap-2">
            <img src="./images/imgi_4_icon-wind.png" class="w-50" alt=""> ${current.wind_kph}km/h
          </span>
          <span class="d-flex align-items-center gap-2">
            <img src="./images/imgi_5_icon-compass.png" class="w-50" alt=""> ${current.wind_dir}
          </span>
        </div>
      </div>
    </div>
